...
'''
def get_payment_url(session_id: str, partner_id: str, application_id: str, bearer_token: str, payment_url: str, payment_data: dict) -> str:
    """
    Sends a payment request to the myPOS API and returns the generated payment URL.

    Args:
        session_id (str): Session ID for the API call.
        partner_id (str): Partner ID provided by myPOS.
        application_id (str): E-commerce Application ID.
        bearer_token (str): Bearer token for authorization.
        payment_url (str): The endpoint URL for generating payment.
        payment_data (dict): Dictionary of payment details.

    Returns:
        str: The generated payment URL.

    Raises:
        ValueError: If 'url' is not found in the response.
        ConnectionError: If the request fails.
    """
